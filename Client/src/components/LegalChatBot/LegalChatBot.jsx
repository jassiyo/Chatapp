...
import { BotImage } from "../BotImage/BotImage";
    ...
    <div className="App">
      <aside className="sidemenu">
        <div className="app-main-title">
          <h2>
            {" "}
            <span className="Legal">Legal</span> Helper
          </h2>
        </div>
        ...
        <div className="profile-space">
          <div className="user-profile" onClick={toggleDropdown}>
            ...
            <div className="dropdown" ref={dropdownRef}>
              {isOpen && (
                <ul className="dropdown-lists">
                  <li className="dropdown-list-text">
                    <PermIdentityIcon />
                    Profile
                  </li>
                  <li className="dropdown-list-text">
            ...
            {/* {showComponent && <DropDown className="DropDown" />} */}
            {/* <DropDown /> */}
          </div>
        </div>
      </aside>
      <section className="chatbox">
        ...
        <div className="chat-log">
          ...
          {showAll && (
            <Button
              color="primary"
              className="Btn-show-less-options"
...
const ChatMessage = ({ message, setChatLog, chatLog, index }) => {
  ...
  const handleSend = () => {
    if (input.trim() !== "") {
      ...
      const newChatLog = [...chatLog];
      newChatLog[index].isAnswered = true;
      newChatLog[index].answer = input;
      setChatLog(newChatLog); // Hide input field permanently
    }
  };
      ...
      <div className={`chat-message ${isBotMessage ? "chatgpt" : "user"}`}>
        ...
        <div className="message-content">
          <div className="message-title">
            {isBotMessage ? `Question ${index + 1}` : "Me"}
          </div>
            ...
            {isBotMessage ? (
              ...
              <>
                ...
                {message.type === "a" ? (
                  ...
                  <div
                    className={`chat-container ${moveLeft ? "move-left" : ""}`}
                  >
